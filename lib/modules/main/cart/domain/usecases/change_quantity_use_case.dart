...
class ChangeQuantityUseCase
  ...
  ChangeQuantityUseCase(this.baseCartRepository);

  @override
  Future<Either<Failure, bool>> call(CartItemStatistics statistics) =>
      baseCartRepository.changeQuantity(statistics);
}
